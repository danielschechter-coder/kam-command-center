...
const ppDataById: Record<string, ProductData> = {
  ...
  // CI-7863 carrier event visibility, CI-8222 [Matrix] EDD holidays, CI-8350 WhatsApp notifications
  "nespresso-br": { ppOrgId: 4407, ppSlug: "pff3c787c3c", ppName: "Nespresso Brazil", contractedVolumeAnnual: 0, ppUsers: 150, ppContractStart: "", ppContractEnd: "", ppModules: [1, 2, 4], adminUrl: ppAdmin("pff3c787c3c"), country: "BR", organizationType: "enterprise" },
  ...
  // CI-8286 Carrier SLA rules, CI-8341 E2E SLA rules, CI-8159 Box Now returns integration
  "nespresso-gr": { ppOrgId: 4441, ppSlug: "p1806673af0", ppName: "Nespresso Greece", contractedVolumeAnnual: 0, ppUsers: 93, ppContractStart: "", ppContractEnd: "", ppModules: [1, 2, 4], adminUrl: ppAdmin("p1806673af0"), country: "GR", organizationType: "enterprise" },
