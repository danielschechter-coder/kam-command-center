...
// Pulled 2026-05-13. These OVERRIDE the Slack-extracted placeholders above
...
const realJiraTickets: (Omit<JiraTicket, "source"> & { accountId: string })[] = [
  // Daniel as reporter (currentUser search):
  ...
  // Tickets cross-referenced from Slack — now with real status from Jira API:
  { accountId: "nespresso-gr", key: "CI-8286", url: jiraUrl("CI-8286"), title: "Nespresso Greece — Feasibility to update SLA rules (Carrier & E2E)", status: "Offen", statusCategory: "new", priority: "High", assignee: "The Nguyen", reporter: "Abbey — Nghi (CS)", issueType: "Task", createdDate: "2026-05-08", updatedDate: "2026-05-12", project: "CI" },
  { accountId: "nespresso-at", key: "CI-8280", url: jiraUrl("CI-8280"), title: "Nespresso Austria — Support Withdrawal Function", status: "Offen", statusCategory: "new", priority: "High", assignee: "Charlotte Roos", reporter: "Abbey — Nghi (CS)", issueType: "Task", createdDate: "2026-05-07", updatedDate: "2026-05-07", project: "CI" },
  ...
  { accountId: "nespresso-cl", key: "CI-8240", url: jiraUrl("CI-8240"), title: "Nespresso Chile — Onboard new carrier E-Darkstore via webhook", status: "Offen", statusCategory: "new", priority: "High", assignee: "Huy Pham", reporter: "Kai — Khai (CS)", issueType: "Task", createdDate: "2026-04-30", updatedDate: "2026-04-30", project: "CI" },
...
// Pulled 2026-05-13 — last 60 days, filtered to customer-domain senders.
